...
alias sharefile="python -m SimpleHTTPServer"
alias gohome="sudo shutdown -h now"
...
# Path to your oh-my-zsh installation.
  export ZSH=/home/ho.viet.tuan/.oh-my-zsh
...
plugins=(git zsh-autosuggestions rails rails3 ruby capistrano bundler heroku rake rvm autojump command-not-found python pip github gnu-utils history-substring-search zsh-syntax-highlighting)
